...
int main(void)
{
    ...
    while(1) 
    {
        ...
        if(received == '1') {
            ...
            delay_ms(500);  // Using delay from delay.h
            GPIO_WriteHigh(LED_PORT, LED_PIN);
        }
        
        // Main task: monitor INPUT1 pin state to control LED
        ...
        delay(10000);  // Using delay from delay.h
    }
}